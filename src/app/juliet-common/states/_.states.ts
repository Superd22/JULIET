import { secureError, secureErrorUnAuthorized } from './errors.state';
...
export let STATES: Ng2StateDeclaration[] = [
    authState, loginState, splashState, secureGoState, secureState,
    unauthorizedState, secureError, secureErrorUnAuthorized
];